    ...
    <header class="flex justify-between items-center px-8 py-4 bg-transparent">
        ...
        <div class="flex items-center gap-6">
            @auth
                ...
                <a href="{{ route('page.box.index') }}" class="flex items-center gap-2 bg-amber-100 text-amber-900 hover:bg-amber-200 px-4 py-2 rounded-md font-semibold transition-all shadow-md border border-amber-200">
