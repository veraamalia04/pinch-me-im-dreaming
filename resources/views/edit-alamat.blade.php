                ...
                <div class="bg-slate-50/50 p-6 rounded-2xl border border-slate-100 transition-all duration-300 hover:bg-white hover:shadow-md hover:border-blue-100 group">
                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <x-form.input value="{{ $address->kota }}" name="kota" label="Kota / Kabupaten" />
                            <x-form.input value="{{ $address->kecamatan }}" name="kecamatan" label="Kecamatan" />
                            <x-form.input value="{{ $address->kelurahan }}" name="kelurahan" label="Kelurahan / Desa" />
                        </div>
                        <div class="w-full md:w-1/3">
                            <x-form.input value="{{ $address->kode_pos }}" name="kode_pos" label="Kode Pos" />
                        </div>
                    </div>
                </div>
